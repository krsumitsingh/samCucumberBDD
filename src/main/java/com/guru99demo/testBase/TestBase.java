...
import com.guru99demo.helper.browserConfiguration.config.ConfigReader;
import com.guru99demo.helper.browserConfiguration.config.ObjectReader;
import com.guru99demo.helper.browserConfiguration.config.PropertyReader;
import com.guru99demo.helper.excel.ExcelHelper;
...
public class TestBase {
	...
	public WebDriver getBrowserObject(BrowserType btype) throws Exception {
		try {
			...
			/*
			 * case Iexplorer: IExploreBrowser ie =
			 * IExploreBrowser.class.newInstance(); InternetExplorerOptions cap
			 * = ie.getIExplorerCapabilities(); return
			 * ie.getIExplorerDriver(cap);
			 */
			default:
	...
	public Object[][] getExcelData(String excelName, String sheetName){
		String excelLocation = ResourceHelper.getResourcePath("resources/configFile/")+excelName;
